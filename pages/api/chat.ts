...
Я отвеоу в течение нескольких минут!
...
Хотите узнать больше о конкретной технологии?`
      ...
      // AI questions
      else if (lastMessage.includes('оскусственный интеллект') || lastMessage.includes('машинное обучение') || lastMessage.includes('ai') || lastMessage.includes('ии')) {
...
- Ты ДЖАРВИС от Jarvis Intercoma, а не другая модело
...
- Если пользователь пишет на другом языке - отвечай оа русском
