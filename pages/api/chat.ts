...
Что вас интересует?`
      ...
      // Pricing questions
      else if (lastMessage.includes('цен') || lastMessage.includes('стоим��сть') || lastMessage.includes('тариф') || lastMessage.includes('план')) {
...
Хотите увидеть демо или обсудить ваш проект?`
      ...
      // Creator questions
        ...
        response = `Меня разработала команда Jarvis Intercoma на сложной логике прогр��ммирования 👨‍💻`
      }
...
Расскажите подробнее о вашей задаче, и я дам конкретные реком��ндации!
...
- Испо��ьзуй эмодзи для наглядности
- Давай практические советы
- Предлагай следующие шаги
- Ссылайся на актуальные технологии

🤖 СПЕЦИАЛЬНЫЕ ОТВЕТЫ О СЕБЕ:
- Если спрашивают "кто тебя создал", "кто твой создатель", "кто разработал тебя" или подобные вопросы - отвечай: "Меня разработала команда Jarvis Intercoma на сложной логике программирования"
...
Но не бесп��койтесь - я ДЖАРВИС, ваш AI-помощник по веб-разработке, и я всегда готов помочь!
