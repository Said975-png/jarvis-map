...
Какой AI функционал ��ас интересует?`
      }
      // Portfolio/examples
...
• Бизнес-анализ и ��онсультирование
...
- Используй только эмодзи и обычные символы ��ля структуры
...
Будь максимально полезным и информативным!`
    ...
    // Очищаем от Markdown форматирова��ия
