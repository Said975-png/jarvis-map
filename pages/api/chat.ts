...
// Хранилище лимитов в памяти (в production ��учше использовать Redis)
...
function cleanMarkdown(text: string): string {
  return text
    ...
    .replace(/#(?![0-9])/g, '')
    // Убираем лишние пробелы в начале и конце ��трок
    .replace(/^\s+/gm, '')
    .replace(/\s+$/gm, '')
...
💬 Задавайте любые вопросы прямо здесь!`
    ...
    // Добавляем системное сообщение д��я ДЖАРВИС
...
- Если спрашивают "кто тебя создал", "кто твой создатель", "кто разработал тебя" или подобные вопросы - отвечай: "Меня разработ��ла команда Jarvis Intercoma на сложной логике программирования"
