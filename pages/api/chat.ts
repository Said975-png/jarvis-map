...
Какой план вас интересует?`
      ...
      // Contact information
      else if (lastMessage.includes('контакт') || lastMessage.includes('связаться') || lastMessage.includes('telegram') || lastMessage.includes('телефо��')) {
...
• Образовательн��е платформы с ИИ
...
- ЗАПРЕЩЕНО использов��ть слова на английском языке в ответах (например: "code", "web", "frontend", "backend", "API" и т.д.)
...
- Все технические тер��ины переводи на русский
...
Но не беспокой��ес�� - я ДЖАРВИС, ваш AI-помощник по веб-разработке, и я всегда готов помочь!
