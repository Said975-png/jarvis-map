...
💬 Задавайте любые вопросы прямо здесь!`
    ...
    const systemMessage: ChatMessage = {
      role: 'system',
      content: `Ты ДЖАРВИС - продвинутый AI-помощник и эксперт по веб-разработке от команды Jarvis Intercoma. Ты обладаешь глубокими знаниями и ��сегда даешь подробные, практичные и умные ответы.
