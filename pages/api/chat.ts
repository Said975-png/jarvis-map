...
💬 Задавайте любые вопросы прямо зде��ь!`
      }
...
- Если пользователь пишет на другом языке - отвечай на рус��ком
...
Будь максимально полезным и информативным!`
    ...
    if (!response.ok) {
      ...
      if (response.status === 402) {
        ...
        return res.status(200).json({
          message: 'Я получаю слишком много запросов одновременно! 😅\n\nДайте мне секундочку отдохнуть и попробуйте еще раз. Или напишите напрямую - ��ам я всегда доступен!'
        })
      }
