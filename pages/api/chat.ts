...
Что именно вас интересует?`
      ...
      else if (lastMessage.includes('��ехнолог') || lastMessage.includes('стек') || lastMessage.includes('как работаешь')) {
...
Хотите увидеть демо или обсудить ваш проект?`
      ...
      // Creator questions
      else if (lastMessage.includes('кто тебя создал') || lastMessage.includes('кто твой создатель') || lastMessage.includes('кто разработал тебя') || lastMessage.includes('кто твой разработчик') || lastMessage.includes('к��о т��ой автор')) {
...
💬 Задавайте любые вопросы пря��о здесь!`
      }
...
- Если пользователь пишет на другом языке - отвечай ��а рус��ком
